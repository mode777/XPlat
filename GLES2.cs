...
namespace GLES2
{
    public static class GL
    {
        ...
        public static extern void BufferSubData(uint target, uint offset, uint size, IntPtr data);
        ...
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint="glDeleteBuffers")]
