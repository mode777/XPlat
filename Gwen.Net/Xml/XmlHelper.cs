            ...
            { typeof(Font), (element, value) =>
                {
                    ...
                    if (element is Gwen.Net.Control.ControlBase)
                        return Font.Create(((Gwen.Net.Control.ControlBase)element).Skin.Renderer, name, size, style);
                    else if (element is Gwen.Net.Xml.Component)
                        return Font.Create(((Gwen.Net.Xml.Component)element).View.Skin.Renderer, name, size, style);
                    else
